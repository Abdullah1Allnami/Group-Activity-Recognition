...
from b4.model import GroupActivityRecognitionB4
...
def baseline_4():
    ...
    # Checkpoint saving paths
    os.makedirs('b4/checkpoints', exist_ok=True)
    best_model_path = 'b4/checkpoints/best_model.pth'
    final_model_path = 'b4/checkpoints/final_model.pth'
    best_val_f1 = 0.0
...
if __name__ == '__main__':
    ...
    parser.add_argument('--baseline', type=int, choices=[1, 2, 3, 4], default=1, help="Baseline model to run (1, 2, 3 or 4)")
