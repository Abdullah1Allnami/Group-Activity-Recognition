...
# Add parent directory of b1 to sys.path to allow running this file directly
sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), '..')))

from b1.config import GROUP_ACTIVITIES, PLAYER_ACTIONS
from b1.dataset import VolleyBallDataset
from b1.model import GroupActivityRecognition
from b1.train import train_epoch, val_epoch
...
def baseline_1():
    ...
    # Override path if we enforce dry-run
    if dry_run:
